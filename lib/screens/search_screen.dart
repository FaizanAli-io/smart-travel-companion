...
class _SearchScreenState extends ConsumerState<SearchScreen> {
  ...
  Widget build(BuildContext context) {
    final results = ref.watch(advancedSearchResultsProvider);
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text('Show', style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w700)),
          ...
          ToggleButtons(
            ...
            children: const [
              ...
              Padding(padding: EdgeInsets.symmetric(horizontal: 20), child: Text('Favorites')),
            ],
          ),
